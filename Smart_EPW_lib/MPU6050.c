...
{
    MPU6050_I2C_ByteWrite(MPU6050_DEFAULT_ADDRESS,0x01,MPU6050_RA_PWR_MGMT_1);      // reg107, 唤醒，8M内部时钟源
    ...
    MPU6050_I2C_ByteWrite(MPU6050_DEFAULT_ADDRESS,0x00,MPU6050_RA_ACCEL_CONFIG);     //加速度量程 2g
    MPU6050_I2C_ByteWrite(MPU6050_DEFAULT_ADDRESS,0x00,MPU6050_RA_GYRO_CONFIG);          //角速度量程 2000度/s
}
